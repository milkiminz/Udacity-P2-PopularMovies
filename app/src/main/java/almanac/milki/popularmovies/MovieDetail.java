...
public class MovieDetail extends Fragment {
    int pos;
    String url,first="http://api.themoviedb.org/3/movie/",end="?api_key=",full,full2,youtubelink;
    ...
    TextView title,ratings,description,reldate;
    ImageView backdrop;
    boolean result;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ratings = (TextView) view.findViewById(R.id.avgratingid);
        description = (TextView) view.findViewById(R.id.overviewid);
        reldate = (TextView) view.findViewById(R.id.reldateid);
        backdrop = (ImageView) view.findViewById(R.id.bd);
